...
export declare class NanoNode {
    ...
    getForwardHistory(account: string, head?: string, offset?: string, account_filter?: string[], count?: number): Promise<INanoAccountHistory>;
    getBackwardHistory(account: string, head?: string, offset?: string, account_filter?: string[], count?: number): Promise<INanoAccountHistory>;
